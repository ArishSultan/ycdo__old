...
namespace ExportImport
{
    public class DefaultAccountsList
    {
        ...
        public DefaultAccountsList()
        {
            this.path = System.Windows.Forms.Application.StartupPath + @"\";
            this.fileNameXML = "DefaultAccountsList.xml";
        }
        ...
        /// </summary>
        /// <returns></returns>
        public bool ExportDefaultAccounts()
        {
            ...
            try
            {
                ...
                Export exp = (Export)peachtreeObj.AppObj.CreateExporter(PeachwIEObj.peachwIEObjDefaultAccounts);
