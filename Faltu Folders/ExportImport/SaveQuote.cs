namespace ExportImport
{
    ...
    {
        private string fileNameCSV = "SaveUSTQuote.csv";
        private string path = (System.Windows.Forms.Application.StartupPath + @"\");
        private PeachtreeSingleTon peachtreeObj;

        public bool DeleteQuote(ref string[] recToDel)
        {
            bool flag;
            try
            {
                this.peachtreeObj = new PeachtreeSingleTon();
                this.peachtreeObj.AppObj.DeleteRecord(PeachBusObjects.pboQuoteEntry, PeachObjectKey.pboKey_ByGUID, ref recToDel);
                flag = true;
            }
        ...
        public string[] ImportQuote()
        {
            ...
            try
            {
                ...
                //imp.AddToImportFieldList((short)PeachwIEObjSalesJournalField .peachwIEObjSalesJournalField_ShipDate);
                ...
                //imp.AddToImportFieldList((short)PeachwIEObjSalesJournalField .peachwIEObjSalesJournalField_ApplyToSalesOrder);
                //imp.AddToImportFieldList((short)PeachwIEObjSalesJournalField .peachwIEObjSalesJournalField_SalesOrderNumber);
                //imp.AddToImportFieldList((short)PeachwIEObjSalesJournalField .peachwIEObjSalesJournalField_SalesOrderDistNum);
                ...
                import.AddToImportFieldList((short)PeachwIEObjSalesJournalField.peachwIEObjSalesJournalField_enSerialNumber);
