    ...
    public partial class FrmLabTest : Form
    {
        ...
        private void FormatGrid()
        {
            for (int i = 0; i < this.GrdMain.Columns.Count; i++)
            {
                ...
                if (this.GrdMain.Columns[i].Name.ToUpper() == "inlt".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "TokenNo".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "TokenDate".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "IsAlwaysPaid".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "IsRsTenInjection".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "Shahab".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "Ghori".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "CurrentAmount".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "TimesADay".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "TotalDays".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "IsMedicine".ToUpper() || this.GrdMain.Columns[i].Name.ToUpper() == "MedIssuedID".ToUpper())
                {
                ...
                if (this.GrdMain.Columns[i].Name.ToUpper() == "OpeningQty".ToUpper())
                {
                    DataGridViewColumn column1 = this.GrdMain.Columns[i];
                    column1.Width = 50;
                }
                ...
                //else
                //    GrdMain.Columns[i].ReadOnly = false;          //// Disabled - 09-03-19
            }
        }
