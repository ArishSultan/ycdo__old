namespace DAL
{
   ...
   // // using ExportImport;
    ...
    //    public DataTable GetShipToAdress(Customer cus)
    //    {
    //        DataTable dt;
    //        try
    //        {
    ...
    //                {
    //                    this.cmd.Connection = this.con;
    //                    this.cmd.CommandText = "Select * from ShipTo where CompanyGuid ='" + peachObj.CurrentCompanyGUID + "' and CustomerID='" + cus.Id + "' Order by ShipToID";
    //                    this.da = new OleDbDataAdapter(this.cmd.CommandText, this.con);
    //                    this.da.Fill(this.dt);
    //                    this.con.Close();
    //                }
    ...
    //                            "insert into shipto(shiptoid,Address1,Address2,City,Country,Recipient,SalesTax,ShipID,State,Zip,CustomerID,CustomerName,CompanyGUID,CompanyName) values('", address.ShipToID, "','", address.AddressLine1, "','", address.AddressLine2, "','", address.City, "','", address.Country, "','", address.Receipent, "','", address.SalesTax, "',", address.ShipId, 
    //                            ",'", address.State, "','", address.Zip, "','", cus.Id, "','", cus.Name, "','", peachObj.CurrentCompanyGUID, "','", peachObj.CurrentCompanyName, "')"
    //                         });
