        ...
        public bool SaveMembershipCollection(MemberCollection mc)
        {
            try
            {
                ...
                if (mc.ID == 0)
                    ...
                    insert = "Insert Into MemberCollection(MemberName,CollectionDate,CollectionFee,ReciptNo) "
                       + "values ('" + mc.MemberName + "',#" + mc.CollectionDate + "#," + mc.CollectionFee + "," + mc.ReciptNo + ")";

                else

                    insert = "Update MemberCollection set MemberName='" + mc.MemberName + "',CollectionDate=#" + mc.CollectionDate + "#,CollectionFee=" + mc.CollectionFee + " ,ReciptNo="+mc.ReciptNo+" where ID=" + mc.ID + "";
