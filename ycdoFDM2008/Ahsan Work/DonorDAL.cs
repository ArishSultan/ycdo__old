        ...
        public List<Donor> GetDonorData()
        {
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    m.CollectionDate =Convert.ToDateTime(dr["CollectionDate"]);
            ...
            finally
            {
             ...
             public DSDonorAndMemberCollection GetDonorAndMemberCollection(Donor d, bool All, bool Donationtype, string fromdate, string todate)
             {
                 ...
                 try
                 {
                     ...
                     string all= "Select DonorName,CollectionDate,CollectionFee,ReciptNo,DonationType,Other,CheckDetail" +
                                  " from DonorCollection where CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#" +
                                  " union all Select MemberName,CollectionDate,CollectionFee,ReciptNo,'' as DonationType," +
                                  " null as Other, null as CheckDetail from MemberCollection where CollectionDate>=#" + fromdate + 
             ...
             public DSDonorPlusMember GetDonorPlusMemberData(Donor d, bool Branches, bool Cities, bool All, bool Donationtype, string fromdate, string todate)
             {
                 DSDonorPlusMember ds = new DSDonorPlusMember();
                 try
                 {


                     string branches = "Select MemberName,MembershipNo,CollectionDate,MemberShipFee,MonthlyFee,BranchName,Refrence,Bloodgroup,'' as FundType,'' as City" +
                         " from MembershipData Where BranchName='" + d.branch.BranchName + "'" +// and CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#" 
                         " union all select DonorName,DonorNo,CollectionDate,DonorFee, null as MonthlyFee,BranchName,'' as Refrence,'' as Bloodgroup, FundType,City" +
                         " from Donor Where BranchName='" + d.branch.BranchName + "'";//and CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#"
                   


                     string all = "Select MemberName,MembershipNo,CollectionDate,MemberShipFee,MonthlyFee,BranchName,Refrence,Bloodgroup,'' as FundType,City" +
                         " from MembershipData " +//and CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#"
                         " union all select DonorName,DonorNo,CollectionDate,DonorFee, null as MonthlyFee,BranchName,'' as Refrence,'' as Bloodgroup, FundType,City" +
                         " from Donor ";//and CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#"


                     string cities = "Select MemberName,MembershipNo,CollectionDate,MemberShipFee,MonthlyFee,BranchName,Refrence,Bloodgroup,'' as FundType,City " +
                         " from MembershipData  Where City='" + d.City.CityName + "'" +
                         " union all select DonorName,DonorNo,CollectionDate,DonorFee, null as MonthlyFee,BranchName,'' as Refrence,'' as Bloodgroup, FundType,City " +
                         " from Donor Where City='" + d.City.CityName + "'";//and CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#"

                     string donationtype = "Select '' as MemberName,null as MembershipNo,null as CollectionDate, null as MemberShipFee,'' as BranchName,'' as FundType,'' as City" +
                         " from MembershipData " +
                         " union all select DonorName,DonorNo,CollectionDate,DonorFee,BranchName, FundType,City" +
                         " from Donor Where FundType='" + d.FundType + "'";//and CollectionDate>=#" + fromdate + "# and CollectionDate<=#" + todate + "#"
