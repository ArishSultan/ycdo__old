...
namespace PCComm
{
    public class CommunicationManager
    {
        ...
        public static string PortMessage;
        #endregion
        ...
        #region WriteData
        public void WriteDataWithoutDisplay(string msg)
        {
        ...
        public bool OpenPort()
        {
            try
            {
                ...
                comPort.Open();
                //Create Port Message
                PortMessage = "Port opened at " + DateTime.Now + "\n";
                //display message
                DisplayData(MessageType.Normal, PortMessage);
                //return true
                return true;
            }
            catch (Exception ex)
