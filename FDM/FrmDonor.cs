...
namespace FDM
{
    public partial class FrmDonor : Form
    {
        ...
        {
            this.cbxFundType.Items.Add(FundsType.Donations.ToString());
        ...
        private void tsSave_Click_1(object sender, EventArgs e)
        {
            try
            {
                if (txtname.Text.Length > 0)
                {
                    ...
                    memb.CollectionDate = Convert.ToDateTime(colldate);
        ...
        private void tsEdit_Click(object sender, EventArgs e)
        {
            ...
            if (frm.CurrentDonor != null)
            {
                ...
                txtMembersshipNo.Text = frm.CurrentDonor.DonorNo.ToString();
                ...
                txtCollectionDate.Text = frm.CurrentDonor.CollectionDate.ToString();
